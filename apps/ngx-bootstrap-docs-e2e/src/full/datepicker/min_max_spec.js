...
describe('Datepicker demo testing suite: Min-max', () => {
    ...
    it('when user clicks on the first, second date from this interval, then it shown in input "mm/dd/yyyy"', () => {
        ...
        datepicker.isInputValueEqual(minMax, `${dateLeft.toLocaleDateString('en-US', { year: 'numeric', month: '2-digit', day: '2-digit' })} - ${dateRight.toLocaleDateString('en-US', { year: 'numeric', month: '2-digit', day: '2-digit' })}`, 1);
    });
});
//# sourceMappingURL=min_max_spec.js.map