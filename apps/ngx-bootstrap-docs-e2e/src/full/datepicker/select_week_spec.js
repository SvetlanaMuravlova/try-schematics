...
describe('Datepicker demo testing suite: Select week', () => {
    ...
    it(`when user click on the week from previous month, then datepicker disappeared and date shown MM/DD/YYYY`, () => {
        ...
        datepicker.clickOnDatepickerWeekItem(3);
        datepicker.isDatepickerOpened(false);
        datepicker.isInputValueContain(selectWeek, `${new Date().getMonth() === 0 ? 12 : new Date().getMonth()}`, 1);
        datepicker.isInputValueContain(selectWeek, `${new Date().getMonth() === 0 ? new Date().getFullYear() - 1 : new Date().getFullYear()}`, 1);
    });
    it(`when user click on the week from previous month, then datepicker disappeared and date shown MM/DD/YYYY
    ...
    it(`when user chose the week from the next month, then datepicker container disappeared
        ...
        datepicker.clickOnDatepickerWeekItem(3);
        datepicker.isDatepickerOpened(false);
        datepicker.isInputValueContain(selectWeek, `${new Date().getMonth() === 11 ? 1 : new Date().getMonth() + 2}`, 1);
        datepicker.isInputValueContain(selectWeek, `${new Date().getMonth() === 11 ? new Date().getFullYear() + 1 : new Date().getFullYear()}`, 1);
    });
...
//# sourceMappingURL=select_week_spec.js.map