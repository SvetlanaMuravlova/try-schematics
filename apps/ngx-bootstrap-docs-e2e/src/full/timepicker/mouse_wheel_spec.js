...
describe('Timepicker demo page testing suite: Mouse wheel', () => {
  ...
  with appropriate changes in info alert`, () => {
        ...
        timepicker.isInputValueContain(mouseWheel, `${currentMinutes < 55 ? currentMinutes + 5 : currentMinutes - 60 + 5}`, 1);
        timepicker.isAlertContains(mouseWheel, `${currentMinutes < 55 ? currentMinutes + 5 : currentMinutes - 60 + 5}`);
        timepicker.triggerEventOnInput(mouseWheel, 'wheel', 1, { deltaY: 1 });
...
//# sourceMappingURL=mouse_wheel_spec.js.map