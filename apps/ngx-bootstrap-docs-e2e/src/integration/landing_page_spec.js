...
describe('Landing Page testing suite', () => {
    ...
    describe('Content', () => {
     ...
     description, version and advantages block`, () => {
        ...
        it('footer contains links to ng-team, contributors, MIT license, Creative Commons, original Bootstrap', () => {
            ...
            footerLinks.forEach(link => landing.isElemHasCorrectUrl('footer', link));
        });
    });
    describe('Navigation buttons', () => {
        ...
        it('Info buttons in header are enabled and contains links to slack, github and stackoverflow', () => {
            ...
            linksArr.forEach(link => landing.isElemHasCorrectUrl(landing.infoButtons, link));
        });
    });
...
//# sourceMappingURL=landing_page_spec.js.map