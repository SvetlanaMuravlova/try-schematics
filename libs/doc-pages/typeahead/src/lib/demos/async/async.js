...
let DemoTypeaheadAsyncComponent = class DemoTypeaheadAsyncComponent {
    constructor() {
        this.statesComplex = [
        ...
        this.dataSource = new Observable((observer) => {
            ...
            .pipe(mergeMap((token) => this.getStatesAsObservable(token)));
    }
...
DemoTypeaheadAsyncComponent = __decorate([
    Component({
...
export { DemoTypeaheadAsyncComponent };
