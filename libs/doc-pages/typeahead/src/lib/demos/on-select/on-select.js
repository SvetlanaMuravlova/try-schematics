...
let DemoTypeaheadOnSelectComponent = class DemoTypeaheadOnSelectComponent {
    constructor() {
...
DemoTypeaheadOnSelectComponent = __decorate([
    Component({
...
export { DemoTypeaheadOnSelectComponent };
//# sourceMappingURL=on-select.js.map