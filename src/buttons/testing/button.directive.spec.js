...
let TestButtonsComponent = class TestButtonsComponent {
    constructor(cdRef, formBuilder) {
        this.cdRef = cdRef;
        ...
        this.radioGroupControl = new FormControl(null);
        this.radioGroupModel = null;
...
`;
function createComponent(htmlTemplate, dtc) {
    switch (dtc) {
        case 'OnPush':
...
describe('Directive: Buttons', () => {
    ...
    describe('radio', () => {
        describe('with reactive form', () => {
            ...
            it('should set disabled attribute when form status is changed to disabled', fakeAsync(() => {
            ...
            it('should not change model when form is disabled', fakeAsync(() => {
                context.myForm.get('radio').setValue('Left');
                fixture.detectChanges();
                tick();
                expect(btn.children[0].classList).toContain('active');
    ...
    describe('radioGroup', () => {
        ...
        function radioGroupTests(reactive) {
            ...
            it('should not have a tabindex if group is disabled', fakeAsync(() => {
            ...
            it('should select radio depending on control value', fakeAsync(() => {
                setModelValue('Right');
                fixture.detectChanges();
                tick();
                fixture.detectChanges();
            ...
            function pressKeyInRadioGroup(key) {
