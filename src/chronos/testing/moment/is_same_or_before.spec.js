...
describe('is same or before', () => {
    ...
    it('is same with utc offset moments', function () {
        ...
        assertOk(moment.parseZone('2013-02-01T00:00:00-05:00').isSameOrBefore(moment.parseZone('2013-02-01T00:00:00-06:30'), 'year'), 'zoned vs (differently) zoned moment');
    });
...
//# sourceMappingURL=is_same_or_before.spec.js.map