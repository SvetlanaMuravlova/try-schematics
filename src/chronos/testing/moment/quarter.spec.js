...
describe('quarter', () => {
    ...
    it('quarter diff', function () {
        assertEq(moment('2014-01-01').diff(moment('2014-04-01'), 'quarter'), -1, 'diff -1 quarter');
        assertEq(moment('2014-04-01').diff(moment('2014-01-01'), 'quarter'), 1, 'diff 1 quarter');
        assertEq(moment('2014-05-01').diff(moment('2014-01-01'), 'quarter'), 1, 'diff 1 quarter');
        assertOk(Math.abs((4 / 3) - moment('2014-05-01').diff(moment('2014-01-01'), 'quarter', true)) < 0.00001, 'diff 1 1/3 quarter');
        assertEq(moment('2015-01-01').diff(moment('2014-01-01'), 'quarter'), 4, 'diff 4 quarters');
    });
...
//# sourceMappingURL=quarter.spec.js.map