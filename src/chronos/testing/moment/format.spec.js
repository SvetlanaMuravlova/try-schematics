...
describe('format', () => {
    ...
    it('utcOffset sanity checks', function () {
        assertEq(Math.abs(moment().utcOffset()) % 15, 0, 'utc offset should be a multiple of 15 (was ' + moment().utcOffset() + ')');
        assertEq(moment().utcOffset(), -(new Date()).getTimezoneOffset(), 'utcOffset should return the opposite of getTimezoneOffset');
    });
    ...
    xit('inspect', function () {
        ...
        assertEq(moment(new Date('nope')).inspect(), 'moment.invalid(/* Invalid Date */)');
        assertEq(moment('blah', 'YYYY').inspect(), 'moment.invalid(/* blah */)');
    });
    ...
    it('calendar day timezone', function () {
        ...
        for (i = 0; i < zones.length; ++i) {
            ...
            assertEq(moment(a).utcOffset(z).calendar(), 'Yesterday at 11:59 PM', 'Yesterday at 11:59 PM, not Today, or the wrong time, tz = ' + z);
        }
