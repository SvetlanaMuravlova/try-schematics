...
describe('is same or after', () => {
    ...
    it('is same or after with utc offset moments', function () {
        ...
        assertOk(moment.parseZone('2013-02-01T00:00:00-05:00').isSameOrAfter(moment.parseZone('2013-02-01T00:00:00-06:30'), 'year'), 'zoned vs (differently) zoned moment');
    });
...
//# sourceMappingURL=is_same_or_after.spec.js.map