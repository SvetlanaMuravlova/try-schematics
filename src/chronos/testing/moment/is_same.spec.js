...
describe('is same', () => {
    ...
    it('is same with utc offset moments', function () {
        ...
        assertOk(moment.parseZone('2013-02-01T00:00:00-05:00').isSame(moment.parseZone('2013-02-01T00:00:00-06:30'), 'year'), 'zoned vs (differently) zoned moment');
    });
...
//# sourceMappingURL=is_same.spec.js.map