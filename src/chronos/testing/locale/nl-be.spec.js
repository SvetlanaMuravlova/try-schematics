...
describe('locale: nl-be', () => {
    ...
    // localeModule('nl-be');
    it('parse', function () {
        var _tests = 'januari jan._februari feb._maart mrt._april apr._mei mei._juni jun._juli jul._augustus aug._september sep._oktober okt._november nov._december dec.'.split('_'), i;
...
//# sourceMappingURL=nl-be.spec.js.map