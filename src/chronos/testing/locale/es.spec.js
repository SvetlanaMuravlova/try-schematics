...
describe('locale: es', () => {
    ...
    // localeModule('es');
    it('parse', function () {
        var _tests = 'enero ene._febrero feb._marzo mar._abril abr._mayo may._junio jun._julio jul._agosto ago._septiembre sep._octubre oct._noviembre nov._diciembre dic.'.split('_'), i;
    ...
    it('calendar day', function () {
        ...
        assertEq(moment(a).calendar(), 'hoy a las 12:00', 'today at the same time');
        assertEq(moment(a).add({ m: 25 }).calendar(), 'hoy a las 12:25', 'Now plus 25 min');
        assertEq(moment(a).add({ h: 1 }).calendar(), 'hoy a las 13:00', 'Now plus 1 hour');
        assertEq(moment(a).add({ d: 1 }).calendar(), 'mañana a las 12:00', 'tomorrow at the same time');
        assertEq(moment(a).add({ d: 1, h: -1 }).calendar(), 'mañana a las 11:00', 'tomorrow minus 1 hour');
        assertEq(moment(a).subtract({ h: 1 }).calendar(), 'hoy a las 11:00', 'Now minus 1 hour');
        assertEq(moment(a).subtract({ d: 1 }).calendar(), 'ayer a las 12:00', 'yesterday at the same time');
    });
