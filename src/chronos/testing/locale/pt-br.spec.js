...
describe('locale: pt-br', () => {
    ...
    // localeModule('pt-br');
    it('parse', function () {
        var _tests = 'Janeiro Jan_Fevereiro Fev_Março Mar_Abril Abr_Maio Mai_Junho Jun_Julho Jul_Agosto Ago_Setembro Set_Outubro Out_Novembro Nov_Dezembro Dez'.split('_'), i;
    ...
    xit('relative time threshold', function () {
        var rts = moment(), rtsDefault = moment.relativeTimeThreshold('ss');
...
//# sourceMappingURL=pt-br.spec.js.map