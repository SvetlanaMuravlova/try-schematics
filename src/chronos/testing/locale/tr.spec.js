...
describe('locale: tr', () => {
    ...
    // localeModule('tr');
    it('parse', function () {
        var _tests = 'Ocak Oca_Şubat Şub_Mart Mar_Nisan Nis_Mayıs May_Haziran Haz_Temmuz Tem_Ağustos Ağu_Eylül Eyl_Ekim Eki_Kasım Kas_Aralık Ara'.split('_'), i;
    ...
    it('format', function () {
        var a = [
            ...
            [199, '200\'üncü'],
            [149, '150\'nci']
        ], dt = moment(new Date(2010, 1, 14, 15, 25, 50, 125)), DDDoDt, i;
