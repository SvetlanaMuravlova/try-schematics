...
describe('locale: fr', () => {
    ...
    // localeModule('fr');
    it('parse', function () {
        var i, _tests = 'janvier janv._février févr._mars mars_avril avr._mai mai_juin juin_juillet juil._août août_septembre sept._octobre oct._novembre nov._décembre déc.'.split('_');
    ...
    it('format month', function () {
        var i, expected = 'janvier janv._février févr._mars mars_avril avr._mai mai_juin juin_juillet juil._août août_septembre sept._octobre oct._novembre nov._décembre déc.'.split('_');
        for (i = 0; i < expected.length; i++) {
            assertEq(moment([2011, i, 1]).format('MMMM MMM'), expected[i], expected[i]);
        }
    });
    it('format week', function () {
        var i, expected = 'dimanche dim. di_lundi lun. lu_mardi mar. ma_mercredi mer. me_jeudi jeu. je_vendredi ven. ve_samedi sam. sa'.split('_');
        for (i = 0; i < expected.length; i++) {
