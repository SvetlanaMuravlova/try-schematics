...
describe('locale: sq', () => {
    ...
    it('parse', function () {
        const _tests = 'Janar Jan_Shkurt Shk_Mars Mar_Prill Pri_Maj Maj_Qershor Qer_Korrik Kor_Gusht Gus_Shtator Sht_Tetor Tet_Nëntor Nën_Dhjetor Dhj'.split('_');
    ...
    it('format week', function () {
        const expected = 'E Dielë Die Di_E Hënë Hën He_E Martë Mar Ma_E Mërkurë Mër Me_E Enjte Enj En_E Premte Pre Pr_E Shtunë Sht Sh'.split('_');
        for (let i = 0; i < expected.length; i++) {
