...
describe('locale: it', () => {
    ...
    // localeModule('it');
    it('parse', function () {
        var _tests = 'gennaio gen_febbraio feb_marzo mar_aprile apr_maggio mag_giugno giu_luglio lug_agosto ago_settembre set_ottobre ott_novembre nov_dicembre dic'.split('_'), i;
