...
describe('locale: hr', () => {
    ...
    // localeModule('hr');
    it('parse', function () {
        var _tests = 'Siječanj Sij_Veljača Velj_Ožujak Ožu_Travanj Tra_Svibanj Svi_Lipanj Lip_Srpanj Srp_Kolovoz Kol_Rujan Ruj_Listopad Lis_Studeni Stu_Prosinac Pro'.split('_'), i;
    ...
    it('format month', function () {
        var expected = 'Siječanj Sij_Veljača Velj_Ožujak Ožu_Travanj Tra_Svibanj Svi_Lipanj Lip_Srpanj Srp_Kolovoz Kol_Rujan Ruj_Listopad Lis_Studeni Stu_Prosinac Pro'.split('_'), i;
    ...
    it('fromNow', function () {
        assertEq(moment()
            .add({ s: 30 })
            .fromNow(), 'za nekoliko sekundi', 'za nekoliko sekundi');
        assertEq(moment()
            .add({ d: 5 })
            .fromNow(), 'za 5 dana', 'za 5 dana');
    });
