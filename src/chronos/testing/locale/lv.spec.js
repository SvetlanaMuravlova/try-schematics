...
describe('locale: lv', () => {
    ...
    // localeModule('lv');
    it('parse', function () {
        var _tests = 'Janvāris Jan_Februāris Feb_Marts Mar_Aprīlis Apr_Maijs Mai_Jūnijs Jūn_Jūlijs Jūl_Augusts Aug_Septembris Sep_Oktobris Okt_Novembris Nov_Decembris Dec'.split('_'), i;
    ...
    it('format week', function () {
        var expected = 'Svētdiena Svētd Sv_Pirmdiena Pirmd Pi_Otrdiena Otrd Ot_Trešdiena Trešd Tr_Ceturtdiena Ceturtd Ce_Piektdiena Piektd Pk_Sestdiena Sestd Se'.split('_'), i;
        for (i = 0; i < expected.length; i++) {
...
//# sourceMappingURL=lv.spec.js.map