import { isValidDate, isValidLimit, toNumber, isNumber, parseHours, parseMinutes, parseSeconds, parseTime, changeTime, setTime, createDate, padNumber, isHourInputValid, isMinuteInputValid, isSecondInputValid, isInputLimitValid, isInputValid } from '../timepicker.utils';
const controls = {
    min: testTime(3, 0, 0),
    max: testTime(17, 0, 0),
    hourStep: 1,
...
function modelTime(hours, minutes, second, PM) {
    return {
        hour: hours,
        minute: minutes,
        seconds: second,
...
//# sourceMappingURL=timepicker.utils.spec.js.map