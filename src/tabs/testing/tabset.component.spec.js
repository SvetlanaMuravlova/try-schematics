...
let TestTabsetComponent = class TestTabsetComponent {
    constructor(config) {
...
], TestTabsetComponent.prototype, "tabset", void 0);
...
describe('Component: Tabs', () => {
    ...
    it('should set tab header', () => {
        ...
        expect(tabTitles[2].getElementsByTagName('span')[0]
            .textContent).toBe(str);
    });
    ...
    it('should appear additional button if removable is true', () => {
        const tabTitles = getTabTitles(element);
        expect(tabTitles[3].querySelectorAll('span.bs-remove-tab').length).toEqual(1);
    });
    it('should remove tab on click on remove icon', () => {
        ...
        const el = tabTitlesBefore[3].querySelectorAll('span.bs-remove-tab')[0];
        el.click();
        fixture.detectChanges();
    ...
    it('should emit remove on remove tab', () => {
        const tabTitles = getTabTitles(element);
        const el = tabTitles[3].querySelectorAll('span.bs-remove-tab')[0];
        el.click();
        fixture.detectChanges();
