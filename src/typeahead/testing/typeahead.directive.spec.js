...
import { of } from 'rxjs';
import { TypeaheadDirective, TypeaheadMatch, TypeaheadModule } from '../index';
let TestTypeaheadComponent = class TestTypeaheadComponent {
    constructor() {
        this.states = [
...
TestTypeaheadComponent = __decorate([
    Component({
        template: `
...
describe('Directive: Typeahead', () => {
    ...
    beforeEach(() => {
        ...
        directive = inputs.map((de) => de.injector.get(TypeaheadDirective))[0];
    });
    ...
    describe('if typeaheadGroupField is not null', () => {
        ...
        it('should result in 2 item matches, when "Ala" is entered', fakeAsync(() => {
            expect(directive.matches).toContainEqual(new TypeaheadMatch({ id: 1, name: 'Alabama', region: 'South' }, 'Alabama'));
    ...
    describe('onBlur', () => {
        it('blur event should send the correct active item', fakeAsync(() => {
            ...
            directive.onBlur();
            expect((_a = directive._container) === null || _a === void 0 ? void 0 : _a.isFocused).toBeFalsy();
            fixture.detectChanges();
        }));
    });
    describe('onChange', () => {
    ...
    describe('if typeaheadOrderBy is not null', () => {
        describe('and source of options is an array of string should result in 2 items, when "Ala" is entered', () => {
            ...
            it('and order direction is not equal "asc" or "desc", shouldn\'t break the app', fakeAsync(() => {
                directive.typeaheadOrderBy = { direction: 'test' };
                console.error = jest.fn();
                dispatchTouchEvent(inputElement, 'input');
                fixture.detectChanges();
                tick(100);
...
//# sourceMappingURL=typeahead.directive.spec.js.map