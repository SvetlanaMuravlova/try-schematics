...
import { TypeaheadConfig, TypeaheadContainerComponent, TypeaheadMatch, TypeaheadOptions } from '../index';
...
describe('Component: TypeaheadContainer', () => {
    ...
    beforeEach(fakeAsync(() => {
        ...
        component.parent.typeaheadOnPreview = new EventEmitter();
    ...
    describe('matches', () => {
        ...
        beforeEach(waitForAsync(() => {
            ...
            fixture.detectChanges();
            matches = asNativeElements(fixture.debugElement.queryAll(By.css('.dropdown-menu button')));
        }));
        describe('rendering', () => {
            ...
            it('should highlight query for match', () => {
                const ms = fixture.debugElement.queryAll(By.css('.dropdown-menu button span'));
    ...
    describe('grouped matches', () => {
        ...
        describe('rendering', () => {
            ...
            it('should highlight query for item match', () => {
                const im = fixture.debugElement.queryAll(By.css('.dropdown-menu button:not(.dropdown-header) span'));
    ...
    describe('scrollable matches', () => {
        let itemMatches;
        let containingElementScrollable;
        beforeEach(waitForAsync(() => {
            fixture = TestBed.createComponent(TypeaheadContainerComponent);
            component = fixture.componentInstance;
            component.parent = {
        ...
        describe('rendering', () => {
            ...
            it('should not throw exception when scrollPrevious is without li elements', () => {
                ...
                component.liElements = undefined;
                // eslint-disable-next-line @typescript-eslint/no-explicit-any
                component.scrollPrevious(1);
...
//# sourceMappingURL=typeahead-container.component.spec.js.map