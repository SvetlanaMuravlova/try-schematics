...
import { DraggableItemService, SortableComponent, SortableModule } from '../index';
...
let TestSortableComponent = class TestSortableComponent {
    constructor() {
        this.heroes = [...HEROES];
        // eslint-disable-next-line @typescript-eslint/no-explicit-any
        this.heroesObj = [...HEROES_OBJ];
    }
};
TestSortableComponent = __decorate([
    Component({
        template: `
...
xdescribe('Component: Sortable', () => {
    ...
    beforeEach(() => {
        ...
        const sortableComponents = fixture.debugElement
            ...
            .map((de) => de.injector.get(SortableComponent));
    ...
    it('different zones should have different ids', () => {
        // eslint-disable-next-line @typescript-eslint/no-explicit-any
        expect(sort1.currentZoneIndex).not.toBe(
        // eslint-disable-next-line @typescript-eslint/no-explicit-any
        sort2.currentZoneIndex);
    });
    describe('onChange', () => {
        ...
        it('should render list of complex models', () => {
            ...
            // assert
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            expect(renderedItems).toEqual(HEROES_OBJ.map((h) => h.name));
        });
    });
    ...
    describe('process drag & drop', () => {
        ...
        beforeEach(inject([DraggableItemService], (service) => {
            ...
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            sort1ZoneNumber = sort1.currentZoneIndex;
    ...
    function getItemsByContainerId(id = 'sort1') {
